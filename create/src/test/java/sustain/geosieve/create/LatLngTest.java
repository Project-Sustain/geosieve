...
public class LatLngTest {
    @Test
    public void varyingPrecisionToString() {
        LatLng point = new LatLng(10.167420, 10.2270);
        assertEquals("10.167420,10.227000", point.toString());
        assertEquals("10.2,10.2", point.toString(1));
        assertEquals("10.17,10.23", point.toString(2));
        assertEquals("10.167,10.227", point.toString(3));
        assertEquals("10.167420,10.227000", point.toString(6));
    }
}
